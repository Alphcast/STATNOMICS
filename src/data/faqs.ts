...
export const faqs: FAQ[] = [
  ...
  { q: 'Do you offer revisions?', a: 'Yes! We offer unlimited revisions within the agreed scope until you are completely satisfied with the deliverable. Your satisfaction is our priority.' },
  { q: 'Can I communicate directly with the expert?', a: 'Yes! Through our WhatsApp chat, you can communicate in real-time with your assigned expert for updates, clarifications, and feedback throughout the process.' },
  { q: 'What tools do you use for data analysis?', a: 'We work with SPSS, R, Python (Pandas, NumPy, Matplotlib), Stata, Excel, Power BI, Tableau, and NVivo for qualitative analysis.' },
  { q: 'Do you help with proposal presentations?', a: 'Absolutely. We design professional slide decks, pitch decks, and proposal documents that make your case visually compelling and persuasive.' },
];
