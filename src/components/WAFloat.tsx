export function WAFloat() {
  return (
    ...
    >
      ...
      <span className="absolute right-[calc(100%+12px)] top-1/2 -translate-y-1/2
                       bg-white/10 backdrop-blur-xl border border-white/10 rounded-lg
                       px-2.5 py-1 text-[10px] text-white whitespace-nowrap
